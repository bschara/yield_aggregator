...
//     option::map(adapter, |v| { strategy.adapter = v; });
//     option::map(max_exposure, |v| { strategy.max_exposure = v; });
//     option::map(risk, |v| { strategy.risk = v; });
//     option::map(active, |v| { strategy.active = v; });
